...
function updateParallax(scrollY) {
    document.querySelector('.stars-layer1').style.transform = `translateY(${scrollY * -0.004}px)`;
    document.querySelector('.stars-layer2').style.transform = `translateY(${scrollY * -0.008}px)`;
    document.querySelector('.stars-layer3').style.transform = `translateY(${scrollY * -0.01}px)`;
    document.querySelector('.stars-layer4').style.transform = `translateY(${scrollY * -0.03}px)`;
    document.querySelector('.stars-layer5').style.transform = `translateY(${scrollY * -0.05}px)`;
    document.querySelector('.stars-layer6').style.transform = `translateY(${scrollY * -0.07}px)`;
}
