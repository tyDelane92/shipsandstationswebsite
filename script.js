...
function updateParallax(scrollY) {
    ...
    document.querySelector('.stars-layer2').style.transform = `translateY(${scrollY * -0.01}px)`;
    document.querySelector('.stars-layer3').style.transform = `translateY(${scrollY * -0.03}px)`;
    document.querySelector('.stars-layer4').style.transform = `translateY(${scrollY * -0.04}px)`;
    document.querySelector('.stars-layer5').style.transform = `translateY(${scrollY * -0.06}px)`;
    document.querySelector('.stars-layer6').style.transform = `translateY(${scrollY * -0.09}px)`;
}
